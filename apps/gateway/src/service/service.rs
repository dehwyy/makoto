use grpc::pkg::api_auth::{SignUpRequest, SignInRequest, AuthorizationResponse,
...
use grpc::pkg::api::api_rpc_server::ApiRpc;
use grpc::pkg::general::BoolStatus;

use makoto::grpc::utils::Result as GrpcResult;
